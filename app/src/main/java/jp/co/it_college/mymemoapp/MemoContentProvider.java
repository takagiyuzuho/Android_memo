...
public class MemoContentProvider extends ContentProvider {
	...
	public static final String AUTHORITY =
			"jp.co.it_college.mymemoapp.MemoContentProvider";
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		int deletedCount = db.delete(MemoContract.Memos.TABLE_NAME,
				selection,
				selectionArgs
		);
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		SQLiteDatabase db = memoOpenHelper.getWritableDatabase();
		int updatedCount = db.update(MemoContract.Memos.TABLE_NAME,
				values,
				selection,
				selectionArgs
		);
